<template>
    <div class="card bg-base-100 w-96 bordered">
        <div class="card-body">
            <div class="title-and-button flex justify-between items-center mb-4">
                <div class="title text-secondary">
                    <p class="font-semibold text-sm">
                        Monthly Budget
                    </p>
                    <p class="text-secondary text-xs italic">
                        Total: $1000
                    </p>
                </div>
...
export default {
    ...
    data () {
        return {
            chartData: {
                labels: ['Transportation', 'Food', 'Utilities', 'Subscriptions', 'Misc.'],
                datasets: [
                    {
